<div class="col-md-3">
    ...
    <div class="col-md-12">
        ...
        <div class="list-group">
            ...
            <a href="pedido.php"  class="list-group-item <?php echo $page == "pedido.php"   ? 'active' : NULL; ?>"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> Pedidos</a>
        </div>
    </div>
