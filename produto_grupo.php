                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <table class="table table-striped table-hover ">
                          ...
                          <?php
                            ...
                            $sql = " SELECT COUNT(*) AS total FROM (PRODUTO ".
                                   " INNER JOIN PRODUTOGRUPO AS PG ON (PG.GRUPO_CONTROLE = {$_grupo} AND PG.PRODUTO_CONTROLE = PRODUTO.PRODUTO_CONTROLE AND PG.STATUS = 1)) ";
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="4">
                                    <span class="pull-right"><?php paginacao(3, $p,$pags, $pesquisa, $_grupo); ?></span>
                                </td>
                            </tr>
                        </tfoot>
                        <?php
